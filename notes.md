...
* I payed for openai api key too
...
1. Do binary retrieval by adding something like EM25
...
3. Semantic splitting/chunking other than simply RecursiveCharacterSplit… e.g. for markdown documents, splitting based on headers within the document
